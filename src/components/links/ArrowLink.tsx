...
type ArrowLinkProps<Custom extends ElementType> = {
  as?: Custom
  direction?: 'left' | 'right'
} & UnstyledLinkProps &
  ComponentProps<Custom>

export function ArrowLink<Custom extends ElementType>({
  children,
  className,
  direction = 'right',
  as,
  ...rest
}: ArrowLinkProps<Custom>) {
  ...
  return (
    <Component
      {...rest}
      className={clsxm(
        'group gap-1 justify-start w-auto ',
